...
<a href="javascript:void(0)" onclick="bulkDeleteEntries(this)" class="tool-action btn btn-transparent purple-wisteria btn-circle btn-sm"><i class="fa fa-trash"></i> {{ trans('backpack::crud.delete') }}</a>
@endif
